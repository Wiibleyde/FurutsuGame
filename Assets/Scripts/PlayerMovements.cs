...
{	
    ...
    void Update()
    {
		...
		transform.position = new Vector3(Mathf.Clamp(transform.position.x + horizontal, -2.5f + currentFruitSize / 60.0f, 2.5f - currentFruitSize / 60.0f), transform.position.y, transform.position.z);
    }
}
